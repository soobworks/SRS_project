...
### 11.3 범위 요약 — REQ-FUNC 매핑

"해야 할 것 / 결정 필요 / 제외할 것"의 전체 요약은 **§1.2(범위)**에 있다. 이 절은 그 요약을 REQ-FUNC ID 단위로 한 번 더 매핑한 것이다.

| 구분 | 대응 REQ-FUNC |
|---|---|
| ✅ 해야 할 것 — 단계 1 | REQ-FUNC-001~021, 024, 025 (§11.1의 FT1~FT7) |
| ✅ 해야 할 것 — 단계 2 | REQ-FUNC-022, 023 (§11.2의 FT8~FT9) |
| 🔶 결정 필요 (TBD) | REQ-FUNC-007/008/015/016 및 FT8(REQ-FUNC-022) 관련 화면 상세 — §1.2, §4.1, PRD §27과 동일 |
| ❌ 제외할 것 | §1.2, §8.4(Non-Goals), PRD §23.2 참조 — REQ-FUNC로 존재하지 않음(요구사항 자체가 없음) |
