...
## 🎯 Summary
- X-002(알림 생성)와 X-003(알림 조회)이 공동으로 충족해야 하는 인수 조건을 테스트로 작성한다. 생성 없이는 조회를 의미 있게 검증할 수 없어 하나의 companion으로 묶는다.

## 🔗 References (Spec & Context)
- 짝이 되는 기능 Task: X-002, X-003
...
- [ ] X-002·X-003 구현 완료 후 전부 통과하는가?

## 🚧 Dependencies & Blockers
- Depends on: I-001, R-003, V-001, V-003
- Blocks: X-002, X-003 완료 처리
